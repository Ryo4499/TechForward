...
from . import CONNECTION, Base, ENGINE, Session
...
def add_test_data() -> dict[str, list[Union[User, Article, Comment, Tag]]]:
    """テストデータをDBに追加する

    Returns:
        dict[str, list[Union[User, Article, Comment, Tag]]]: 追加したテストデータの辞書
    """
    users = []
    admins = []
    tags = []
    ...
    with Session() as session:
        ...
        tags.append(jstag)
        tags.append(pythontag)
        tags.append(gittag)
        tags.append(htmltag)
        tags.append(progtag)
        tags.append(umltag)
        tags.append(katextag)
        tags.append(javatag)
        tags.append(javatag)
        ...
        articles.append(pipArticle)
        articles.append(gitArticle)
        articles.append(jsArticle)
        articles.append(htmlArticle)
        articles.append(musicArticle)
        articles.append(plantUmlArticle)
        articles.append(katexArticle)
        articles.append(todoArticle)
        articles.append(dockerArticle)
